...
public class SoalTIUPaketBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_tiu_paket_b);
    ...
    public void next(View view) {
        if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked() || rb5.isChecked()) {
            ...
            if (nomor < pertanyaan_kuis.length) {
                ...
                hasil = benar * 20;
                Intent selesai = new Intent(getApplicationContext(), HasilTIUPaketBActivity.class);
